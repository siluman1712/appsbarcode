...
?>
                    <section class="content-header">
                      <h1>
                        Daftar Kodefikasi Barang Milik Negara
                      </h1>
                    </section>
                                        ...
                                        <table id="table_3" class="table table-bordered table-striped responsive">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th bgcolor='#dcdcdc'> Uraian BMN</th>
                                                    <th bgcolor='#dcdcdc'> Kode Perkiraan</th>
                                                    <th bgcolor='#dcdcdc'> Kode Barang</th>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $sensus = mysqli_query($koneksi, 
                                                          "SELECT a.satuan, a.ur_sskel,
                                                                  a.kd_brg, a.kd_perk
                                                           FROM b_nmbmn a 
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo "$r[kd_perk]"; ?></td>
                                                        <td><strong><h1><?php echo "$r[kd_brg]"; ?></h1></strong></td>
                                                    </tr>
                                                    </tfoot>
                                                <?php } ?>
                                        </table>    
