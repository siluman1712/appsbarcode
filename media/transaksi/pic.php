...
?>
                    ...
                    <i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp; Daftarkan PIC BMN</a>
                        <div class="box">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="table_1" class="table table-bordered table-striped responsive">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th bgcolor='#dcdcdc'> PIC NIP </th>
                                                    <th bgcolor='#dcdcdc'> PIC Nama</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $dist = mysqli_query($koneksi, 
                                                          "SELECT a.picnip, a.picnama,  
                                                                  a.noaset, a.kodebarang,
                                                                  b.kd_brg, b.ur_sskel, b.satuan
                                                           FROM dbpicbmn a
                                                           LEFT JOIN b_nmbmn b ON b.kd_brg = a.kodebarang                                                 
                                                           ORDER BY a.picnip ASC");
                                                $no = 0;
